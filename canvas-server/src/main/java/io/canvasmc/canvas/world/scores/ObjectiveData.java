...
public class ObjectiveData {
    ...
    public ObjectiveData setNumberFormat(@Nullable final NumberFormat numberFormat) {
        this.numberFormat = numberFormat;
        return this;
    }

    public static ObjectiveData fromObjective(final @NonNull Objective objective) {
        return new ObjectiveData(
    ...
    public void applyTo(final @NonNull Objective objective) {
        objective.setDisplayName(this.displayName);
        // formattedDisplayName is computed from displayName in 1.21.11
        objective.setRenderType(this.renderType);
        objective.setDisplayAutoUpdate(this.displayAutoUpdate);
        objective.setNumberFormat(this.numberFormat);
    }
}
